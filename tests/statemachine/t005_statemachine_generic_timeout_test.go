...
type t22_generic_timeouts struct {
	statemachine.StateMachine[t22_generic_timeouts_data]
}
...
func (sm *t22_generic_timeouts) Init(args ...any) (statemachine.StateMachineSpec[t22_generic_timeouts_data], error) {
	spec := statemachine.NewStateMachineSpec(gen.Atom("state1"),
		// initial data
		statemachine.WithData(t22_generic_timeouts_data{}),

		// set up a message handler to start timeout1
		statemachine.WithStateMessageHandler(gen.Atom("state1"), t22_handle_start_timeout),

		// set up a message handler for timeout1_timed_out message
		statemachine.WithStateMessageHandler(gen.Atom("state1"), t22_handle_timeout1_timed_out),

		// set up a call handler to query the number of timeouts
		statemachine.WithStateCallHandler(gen.Atom("state1"), t22_handle_get_timeouts),
	)

	return spec, nil
}

func t22_handle_start_timeout(state gen.Atom, data t22_generic_timeouts_data, message t22_start_timeout, proc gen.Process) (gen.Atom, t22_generic_timeouts_data, []statemachine.Action, error) {
	timeout := statemachine.GenericTimeout{
...
func t22_handle_timeout1_timed_out(state gen.Atom, data t22_generic_timeouts_data, message t22_timeout1_timed_out, proc gen.Process) (gen.Atom, t22_generic_timeouts_data, []statemachine.Action, error) {
	data.timeouts++
	return state, data, nil, nil
}

func t22_handle_get_timeouts(state gen.Atom, data t22_generic_timeouts_data, message t22_get_timeouts, proc gen.Process) (gen.Atom, t22_generic_timeouts_data, int, []statemachine.Action, error) {
