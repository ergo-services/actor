...
type t21_state_timeouts struct {
	statemachine.StateMachine[t21_state_timeouts_data]
}
...
func (sm *t21_state_timeouts) Init(args ...any) (statemachine.StateMachineSpec[t21_state_timeouts_data], error) {
	spec := statemachine.NewStateMachineSpec(gen.Atom("state1"),
		// Set up the initial data.
		statemachine.WithData(t21_state_timeouts_data{}),
		...
		statemachine.WithStateMessageHandler(gen.Atom("state1"), t21_trigger_timeout_from_message),
		...
		statemachine.WithStateMessageHandler(gen.Atom("state2"), t21_trigger_second_timeout_from_message),

		// Set up a message handler for state2 that handles the second timeout
		// message.
		statemachine.WithStateMessageHandler(gen.Atom("state2"), t21_handle_second_timeout_message),

		// Set up a call handler for the transition [state1] -> [state2] that
		// configures a state timeout with a configurable duration and sends
		// `t21_state1` on timeout.
		statemachine.WithStateCallHandler(gen.Atom("state1"), t21_trigger_timeout_from_call),

		// Set up a message handler for the transition [state2] -> [state1], we
		// will send this message when the state timeout times out.
		statemachine.WithStateMessageHandler(gen.Atom("state2"), t21_move_to_state1),

		// Set up a message handler for the transition [state2] -> [state3].
		statemachine.WithStateMessageHandler(gen.Atom("state2"), t21_move_to_state3),

		// Set up a call handler to query the state and the number of state
		// timeouts
		statemachine.WithStateCallHandler(gen.Atom("state1"), t21_get_state_and_timeouts),
		statemachine.WithStateCallHandler(gen.Atom("state2"), t21_get_state_and_timeouts),
		statemachine.WithStateCallHandler(gen.Atom("state3"), t21_get_state_and_timeouts),

		// Set up event handler that configures a state timeout.
		statemachine.WithEventHandler(gen.Event{Name: "testEvent", Node: "t21node@localhost"}, t21_trigger_timeout_from_event),
	)

	return spec, nil
}

func t21_trigger_timeout_from_message(state gen.Atom, data t21_state_timeouts_data, message t21_state2, proc gen.Process) (gen.Atom, t21_state_timeouts_data, []statemachine.Action, error) {
	timeout := statemachine.StateTimeout{
		Duration: message.timeoutAfter,
		Message:  t21_state1{},
	}
	return gen.Atom("state2"), data, []statemachine.Action{timeout}, nil
}

func t21_trigger_second_timeout_from_message(state gen.Atom, data t21_state_timeouts_data, message t21_trigger_second_timeout, proc gen.Process) (gen.Atom, t21_state_timeouts_data, []statemachine.Action, error) {
	timeout := statemachine.StateTimeout{
...
func t21_trigger_timeout_from_call(state gen.Atom, data t21_state_timeouts_data, message t21_state2, proc gen.Process) (gen.Atom, t21_state_timeouts_data, int, []statemachine.Action, error) {
	timeout := statemachine.StateTimeout{
		Duration: message.timeoutAfter,
		Message:  t21_state1{},
	}
	return gen.Atom("state2"), data, 0, []statemachine.Action{timeout}, nil
}

func t21_trigger_timeout_from_event(state gen.Atom, data t21_state_timeouts_data, message t21_state2, proc gen.Process) (gen.Atom, t21_state_timeouts_data, []statemachine.Action, error) {
	timeout := statemachine.StateTimeout{
		Duration: message.timeoutAfter,
		Message:  t21_state1{},
	}
...
func t21_move_to_state1(state gen.Atom, data t21_state_timeouts_data, message t21_state1, proc gen.Process) (gen.Atom, t21_state_timeouts_data, []statemachine.Action, error) {
	data.timeouts++
	return gen.Atom("state1"), data, nil, nil
}

func t21_move_to_state3(state gen.Atom, data t21_state_timeouts_data, message t21_state3, proc gen.Process) (gen.Atom, t21_state_timeouts_data, []statemachine.Action, error) {
	return gen.Atom("state3"), data, nil, nil
}

func t21_handle_second_timeout_message(state gen.Atom, data t21_state_timeouts_data, message t21_second_timeout, proc gen.Process) (gen.Atom, t21_state_timeouts_data, []statemachine.Action, error) {
	data.timeouts++
	return state, data, nil, nil
}

func t21_get_state_and_timeouts(state gen.Atom, data t21_state_timeouts_data, message t21_state_and_timeouts, proc gen.Process) (gen.Atom, t21_state_timeouts_data, t21_state_and_timeouts, []statemachine.Action, error) {
